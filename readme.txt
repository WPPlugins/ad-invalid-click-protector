...
[youtube https://www.youtube.com/watch?v=kKFrhtjjvzM]
...
* Reducing dependency on IP-API.com. Now the API call will only be made when you are using country wide ban. Also in the Banned User Details table the Country Name and Country Code has been removed to ensure less dependency on 3rd Paty APIs.
